...
const Contact = () => {
  ...
  return (
    <div
      className={`sm:text-[18px] text-[14px] lg:mt-12 flex lg:flex-row flex-col-reverse justify-evenly overflow-hidden`}
    >
      <motion.div
      ...
      <motion.div
        ...
        className="lg:flex-1 md:h-[650px] h-[350px] lg:w-1/2 w-3/4 self-center"
      >
        <EarthCanvas />
      </motion.div>
    </div>
